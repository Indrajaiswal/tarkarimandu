...
<section class="display-order">
   ...
   ?>
   <p> <?php echo $fetch_cart['name']; ?> <span>(<?php echo 'Nrs. '.$fetch_cart['price'].'/-'.' x '. $fetch_cart['quantity']; ?>)</span> </p>
   <?php
      }
   }else{
   ...
   ?>
   <div class="grand-total"> Grand Total : <span>Nrs. <?php echo $grand_total; ?>/-</span> </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method">
               ...
               <option value="Khakti">Khalti</option>
            </select>
         </div>
         <div class="inputBox">
